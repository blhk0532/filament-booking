...
class FilamentBookingServiceProvider extends PackageServiceProvider
{
    ...
    protected function getAssets(): array
    {
        ...
        if (is_dir($distPath)) {
            return [
            // AlpineComponent::make('filament-booking', __DIR__ . '/../resources/dist/components/filament-booking.js'),
                Css::make('filament-booking-styles',  $distPath . '/resources/dist/filament-booking.css'),
                Js::make('filament-booking-scripts', $distPath . '/resources/dist/filament-booking.js'),
            ];
        }
